  ...
  return (
    <div >
      ...
      <div
        ...
        className="md:border-t-solid md:border-[gray] md:border-l-2 md:border-b-2 md:rounded-bl-[10px] md:mt-[100px]  md:mx-[auto] m-[40px auto]"
      >
        <div style={{ width: "100%" }} className="skillsStyle">
